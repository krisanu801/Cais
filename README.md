...
For a simple prompt like "create a better optimizer than rmsprop and adam and compare only on *makemoons" it gave us output [PDF1](AIgeneratedpaper.pdf) , [PDF2](
